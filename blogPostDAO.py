...
class BlogPostDAO:
    ...
    def add_comment(self, permalink, name, email, body):
        ...
        try:
            ...
            noOfDocsUpdated = self.posts.update({"permalink": permalink}, {"$push" : {"comments" : comment}})
            return noOfDocsUpdated  # Change this to return the number of documents updated by the code for HW 3.3
